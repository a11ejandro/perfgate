...
require "baselined/execution/process_runner"

RSpec.describe Baselined::Execution::ProcessRunner do
  def workload(&block)
    Baselined::Workloads::Workload.new(id: "isolated", samples: 2, warmup: 0, metrics: [:duration], &block)
  end
