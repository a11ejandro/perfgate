...
require "baselined/fingerprints/workload_definition"
require "baselined/workloads/workload"

RSpec.describe Baselined::Fingerprints::WorkloadDefinition do
  describe ".hash_for" do
    def workload(id: "checkout_flow", samples: 8, warmup: 2, metrics: %i[duration sql_count])
      Baselined::Workloads::Workload.new(id: id, samples: samples, warmup: warmup, metrics: metrics) { nil }
    end
