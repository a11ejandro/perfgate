...
require "baseline/fingerprints/workload_definition"
require "baseline/workloads/workload"

RSpec.describe Baseline::Fingerprints::WorkloadDefinition do
  describe ".hash_for" do
    def workload(id: "checkout_flow", samples: 8, warmup: 2, metrics: %i[duration sql_count])
      Baseline::Workloads::Workload.new(id: id, samples: samples, warmup: warmup, metrics: metrics) { nil }
    end
