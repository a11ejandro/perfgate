...
require "fileutils"
require "json"
require "baseline/cli/run_comparison_reporter"
require "baseline/serialization/run_result"
require "baseline/config"

RSpec.describe Baseline::CLI::RunComparisonReporter do
  around do |example|
  ...
  def write_run(dir, samples)
    ...
    run_result = Baseline::Serialization::RunResult.build([workload_result])
