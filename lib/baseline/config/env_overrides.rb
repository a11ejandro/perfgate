...
module Baseline
  class Config
    # Applies BASELINE_-prefixed environment variable overrides on top of
    # a merged configuration hash, per spec section 11 ("environment-
    # variable overrides use a documented BASELINE_ prefix"). Any leaf
    # path can be overridden, e.g. BASELINE_EXECUTION_SAMPLES=12 overrides
