...
module Baseline
  module Fingerprints
    ...
    module Components
      ...
      def collect(config: Baseline.configuration)
      ...
      def strict_components(config)
        {
          ...
          "baseline_version_major" => Baseline::VERSION.split(".").first,
      ...
      def informational_components
        {
          ...
          "runner_image" => ENV.fetch("BASELINE_RUNNER_IMAGE", nil),
      ...
      def cpu_model
        ENV.fetch("BASELINE_CPU_MODEL", nil)
      end
