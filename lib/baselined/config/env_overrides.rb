...
module Baselined
  class Config
    # Applies BASELINED_-prefixed environment variable overrides on top of
    # a merged configuration hash, per spec section 11 ("environment-
    # variable overrides use a documented BASELINED_ prefix"). Any leaf
    # path can be overridden, e.g. BASELINED_EXECUTION_SAMPLES=12 overrides
