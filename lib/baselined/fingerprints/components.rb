...
module Baselined
  module Fingerprints
    ...
    module Components
      ...
      def collect(config: Baselined.configuration)
      ...
      def strict_components(config)
        {
          ...
          "baseline_version_major" => Baselined::VERSION.split(".").first,
      ...
      def informational_components
        {
          ...
          "runner_image" => ENV.fetch("BASELINED_RUNNER_IMAGE", nil),
      ...
      def cpu_model
        ENV.fetch("BASELINED_CPU_MODEL", nil)
      end
